              ...
              {property ? (
                ...
                >
                  ...
                  <div className="id-property-info">
                    ...
                    <p>
                      <FiMapPin /> {property.location?.city}
                ...
                <div className="id-visit-schedule">
                  ...
                  <div className="id-visit-row">
                    ...
                    {inquiry.preferredVisitTime && (
                      <span>
                        <FiClock /> {inquiry.preferredVisitTime}
                      </span>
                    )}
                  </div>
                </div>
            ...
            <div className="id-card">
              ...
              <div className="id-parties">
                <div className="id-party">
                  ...
                  <div>
                    <p className="id-party-name">
                      {sender?.name}{" "}
                      {isSender && <span className="id-you-tag">You</span>}
                    </p>
                    <p className="id-party-role">Inquiry Sender</p>
                  </div>
                </div>
                <div className="id-party">
                  <div className="id-avatar id-avatar-owner">
                ...
                {inquiry.responses?.length > 0 ? (
                  inquiry.responses.map((res, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className={`id-bubble ${isOwn ? "id-bubble-sent" : "id-bubble-received"}`}
                      >
                        <div className="id-bubble-meta">
              ...
              {inquiry.status !== "cancelled" &&
                inquiry.status !== "completed" && (
                  <form className="id-reply-form" onSubmit={handleReply}>
                    ...
                    />
                    {replySuccess && (
                      <p className="id-reply-success">
                        <FiCheckCircle /> Reply sent!
                      </p>
                    )}
                    <button
                      type="submit"
                      className="id-reply-btn"
                      disabled={sending}
                    >
