...
const PrivacyPolicy = () => {
  return (
    <div className="legal-page">
      <div className="legal-hero"></div>

      <div className="legal-container">
        <div className="legal-content">
          <section className="legal-section">
            <h2>
              <FiShield /> Your Privacy Matters
            </h2>
            <p>
              At Logic Wave Property, we are committed to protecting your
          ...
          <section className="legal-section">
            ...
            <ul>
              ...
              <li>
                <strong>Property Listings:</strong> Property details, images,
              ...
              <li>
                ...
                premium services (processed securely)
              </li>
              <li>
                <strong>Verification Documents:</strong> ID proofs, property
                documents (if you choose verification)
              </li>
            </ul>
          ...
          <section className="legal-section">
            ...
            <ul>
              ...
              <li>
                Display your property listings to potential buyers/renters
              </li>
          ...
          <section className="legal-section">
            ...
            <p>
              When you contact a seller or respond to an inquiry, we share
              necessary contact information to facilitate communication.
            </p>
          ...
          <section className="legal-section">
            ...
            <ul>
              ...
              <li>
                <strong>Advertising Cookies:</strong> Used to show relevant
                advertisements
              </li>
            </ul>
          ...
          <section className="legal-section">
            ...
            <p>
              You can request account deletion at any time. We will delete your
              personal information, but may retain some data for legal or
          ...
          <section className="legal-section">
            ...
            <p>
              After account deletion, we may retain certain information for up
              to 90 days for backup purposes, and some data may be retained
          ...
          <section className="legal-section">
            ...
            <p>
              ...
              notify you of material changes via email or through our platform.
          ...
          <section className="legal-section">
            ...
            <div className="contact-info">
              <p>
                <strong>Email:</strong> privacy@logicwaveproperty.com
              </p>
              <p>
                <strong>Phone:</strong> +91 1800-XXX-XXXX
              </p>
              <p>
                <strong>Address:</strong> Data Protection Officer, Logic Wave
                Property, Mumbai, India
              </p>
            </div>
          </section>
        ...
        <aside className="legal-sidebar"></aside>
      </div>
    </div>
  );
};
