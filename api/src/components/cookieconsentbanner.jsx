    ...
    <div className="cookie-consent-banner">
      <div className="cookie-banner-content">
        ...
        <p className="cookie-banner-description">
          We use cookies to enhance your experience on Logic Wave Property. Some
          cookies are essential for the site to function, while others help us
          improve your experience and deliver personalized content.
        </p>
        ...
        <div className="cookie-preferences">
          <div className="cookie-preference-item">
            ...
            <p className="preference-description">
              Essential for basic site functionality. These cookies cannot be
              disabled.
            </p>
          </div>
          ...
          <div className="cookie-preference-item">
            ...
            <p className="preference-description">
              Used to deliver personalized advertisements and track marketing
              effectiveness.
            </p>
          </div>
        </div>
